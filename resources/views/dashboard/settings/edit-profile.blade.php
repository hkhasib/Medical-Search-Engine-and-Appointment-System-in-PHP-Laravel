                            ...
                            <div class="panel-body">
                                <form action="{{route('store.user.edit')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    ...
                                    @if(session('user_role')=='doctor')
                                        <div class="row">
                                            <div id="doctor-details" class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="designation" class="form-control" value="{{$data[0]->designation}}" placeholder="Designation" name="designation" required> <span class="help-block"> Example: Cardiologist </span> </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" value="{{$data[0]->specialities}}" id="specialities" name="specialities" class="form-control" placeholder="Input Your Specialities" required> <span class="help-block"> Mention Your Specialities </span> </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea required class="form-control" id="education" placeholder="Give Education Details" name="education">{{$data[0]->education}}</textarea>
