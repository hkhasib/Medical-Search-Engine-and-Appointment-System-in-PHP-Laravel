    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title">Add New States</h3></div>
                    <div class="col-sm-12 col-xs-12">
                        <form method="post" action="{{route('store.location.state')}}">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="input-group m-t-10">
                                    <input type="text" name="state" class="form-control" placeholder="State Name"> <span class="input-group-btn">
