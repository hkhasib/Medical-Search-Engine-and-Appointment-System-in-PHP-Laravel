                            ...
                            <table id="myTable" class="table table-striped">
                                ...
                                @foreach($data_list as $data)
                                    <tr>
                                        ...
                                        <td><form method="post" action="/store-user-authorization/{{$data->user_id}}">
                                                @csrf
                                                <select name="status" id="authorization_select" required>
                                                <option disabled selected value> -- Select Action -- </option>
                                                <option value="inactive">Block</option>
                                                <option value="active">Allow</option>
                                                </select>
                                                <input type="hidden" required name="username" value="{{$data->username}}">
                                                <input type="hidden" required name="role" value="{{$data->role}}">
                                                <button type="submit" class="btn btn-dribbble" id="auth_btn">Submit</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
