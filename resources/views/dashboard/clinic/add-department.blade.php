    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title">Add Departments</h3></div>
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <form method="post" action="{{route('store.department')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input required type="text" name="keywords" class="form-control" placeholder="Keywords1,keywords2...."></div>
                                <div class="input-group m-t-10">
                                    <input type="text" name="department" class="form-control" placeholder="Department Name"> <span class="input-group-btn">
